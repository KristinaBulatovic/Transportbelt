            ...
            <div class="meniFasic">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="<?php echo site_url("index.php/welcome/index/#klijenti"); ?>">Klijenti</a></li>
...
<div class="container-fluid">
    <div class="row content">
        <div class="container">
            ...
            <h2 class="text-center">Gumeno-tehnička roba</h2>
            <br>
            <p class="text-justify">U mogućnosti smo da Vam ponudimo sledeću gumeno-tehničku robu: <br><br>

                ● Gumena creva za vazduh, vodu, naftu i naftne derivate, hemijsku industriju, ulja;<br><br>

                a) Tehnička gumena ploča u rolnama i tablama: debljine= 1-50mm<br>
                Proizvodnje: FTT WOLBROM S.A. (Stomil) - Poljska, ,,Artego" Rumunija<br>
                Kvaliteti gumenih ploča: Normalna, uljnootporna, kiselootporna, antistatična, antiabrazivna,
                ploča na bazi EPDM-a, otporne na temperaturi, ploče sa tekstilnim ulošcima.<br>
                Standardne dimenzije rolni: 1200 x 10000 x debljina.<br><br>

                b) PODNA GUMENA PLOČA: Za oblaganje podova, staza, stepeništa, platformi, vagona, paluba, eskalatora,
                hala i radnih stolova.<br>
                Tipovi: Bolo sa krugovima, srednji dezen, SD - sitni dezeni, KD - krupan dezen, glatke i u bojama po zahtevu <br><br>

                c) GUMENE IZOLACIONE PROSTIRKE (PLOČE)<br>
                Gumene izolacione prostirke se proizvode sa dobrim elektroizolovanim mehaničkim osobinama - Proizvodnje FTT Wolbrom
                (Stomil) - Poljska, a koje su ponovo sertifikovane od domačeg akreditovanog tela - Instituta za zaštitu na radu AD - Novi Sad.<br>
                Ove gumene prostirke se nude u standardnim dimenzijama:<br>
                1250 x 10000 x 4 mm = 12,5 m2 / rolna<br>
                1250 x 10000 x 6 mm = 12,5 m2 / rolna<br>
                Elektroizolacione prostirke zadovoljavaju ispitni napon od 20 kV, a svaku rolnu prati odgovarajući sertifikat o izvršenoj kontroli.
                <br><br>
                d) BRISAČI I USMERIVAČI ZA TRANSPORTERE SA GUMENOM TRAKOM.<br>
